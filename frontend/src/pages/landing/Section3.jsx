        ...
        <div className='md:pb-12 pb-6 lg:pb-16 overflow-x-hidden'>
            <div>
                <div className='flex items-center justify-between w-full'>
                    <h1 className='text-3xl font-bold text-white flex items-center gap-2'><FaPlay className='text-[18px] text-[#3d4afe]' />Populer </h1>
