        ...
        <div className='pb-20 overflow-x-hidden'>
            <div>
                <div className='flex items-center justify-between w-full'>
                    <h1 className='text-3xl font-bold text-white flex items-center gap-2'><FaPlay className='text-[18px] text-[#3d4afe]' /> Top Rated</h1>
                ...
                <div className='flex items-center flex-nowrap gap-2 mt-5' >
                    {
                        !loading ? movies.map((movie, idx) => {
                            return idx < 10 && <div style={{ transform: `translateX(-${translate}%)` }} className='h-[380px] transition ease duration-500 lg:w-[20%] w-[47%] sm:w-[33.33%] md:w-[25%] xl:w-[17%] 2xl:w-[14%] shrink-0 px-2 py-1'>
