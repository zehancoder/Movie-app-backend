...
import { errorMsgState, usersStoreState, userstoreDataErr } from '../../../toolkit/slice';
...
function Users() {
  ...
  return (
    <div className='min-h-screen px-5 py-10 relative'>
      ...
      <div class={`space-y-12 p-4 transition duration-300 fixed bottom-20 right-5 ${deleteMessage !== '' ? 'translate-x-0' : 'translate-x-[150%]'} `}>
