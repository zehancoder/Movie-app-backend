    ...
    return (
        <div>
            <div class="min-h-screen flex fle-col items-center justify-center">
                <div classn="py-6 px-4">
                    <div class="max-w-6xl w-full bg-[#BFC9D1] shadow-lg shadow-gray-600 rounded-lg">
                            ...
                            <form class="space-y-6" >
                                ...
                                <div>
                                    ...
                                    <div class="relative flex items-center">
                                        <input onChange={(e) => setEmail(e.target.value)} name="email" type="email" required class="w-full text-sm text-slate-900 border border-slate-300 pl-4 pr-10 py-3 rounded-lg outline-blue-600" placeholder="Enter email" />
                                ...
                                <div>
                                    ...
                                    <div class="relative flex items-center">
                                        <input onChange={(e) => setPassword(e.target.value)} name="password" type="password" required class="w-full text-sm text-slate-900 border border-slate-300 pl-4 pr-10 py-3 rounded-lg outline-blue-600" placeholder="Enter password" />
                                ...
                                <div class="!mt-12">
                                    <button onClick={loginUserFunc} type="button" class="w-full shadow-xl py-2.5 px-4 text-[15px] font-medium tracking-wide rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none cursor-pointer">
                                        Sign in
                                    </button>
                                    <Link to={'/register'} class="text-sm !mt-6 text-center text-slate-600">Don't have an account <a href="javascript:void(0);" class="text-blue-600 font-medium hover:underline ml-1 whitespace-nowrap">Register here</a></Link>
                                </div>
                            </form>
                        </div>
